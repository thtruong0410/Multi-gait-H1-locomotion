...
from rsl_rl_lib.vecenv_wrapper import RslRlVecEnvWrapper

import isaaclab_tasks  # noqa: F401
from isaaclab_tasks.utils import get_checkpoint_path, parse_env_cfg

import UnitreeG1.tasks  # noqa: F401
...
def main():
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            env.env.env.command_manager.get_command(command_name)[:, 6] = 0.2 # foot swing 
            env.env.env.command_manager.get_command(command_name)[:, 7] = -0.2 # body height 
            env.env.env.command_manager.get_command(command_name)[:, 8] = 0.0 # body pitch 
